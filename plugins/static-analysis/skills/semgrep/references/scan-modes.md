...
The scan workflow adds these itself. This is what it emits, and what the fallback path in
[scanner-task-prompt.md](scanner-task-prompt.md) has to reproduce by hand.
